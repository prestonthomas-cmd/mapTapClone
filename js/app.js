...
(function (MT) {
  ...
  function showHelp(backToMenu) {
    openPanel(
      ...
      '<h3>Scoring</h3>' +
      '<ul>' +
        '<li>Within 25 km — a clean <strong>100</strong></li>' +
        '<li>100 km — about <strong>94</strong></li>' +
        '<li>500 km — about <strong>72</strong></li>' +
        '<li>1000 km — about <strong>51</strong></li>' +
        '<li>Past 5000 km there is almost nothing left</li>' +
      '</ul>' +
